...
4. Run [ npx cypress run ] to start Cypress in Headless mode, let it run and finish by itself
5. After Cypress finished with the test, it will generate a Video file contains the run + generate a report file in .json 
6. In Terminal, run [ npm run cy:report ] in order to generate a new report file 
